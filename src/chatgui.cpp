    ...
    : wxPanel(parent, -1, wxPoint(-1, -1), wxSize(-1, -1), wxBORDER_NONE)
{
    ...
    _chatBotImg = std::make_unique<wxStaticBitmap>(this, wxID_ANY,
            (isFromUser ? wxBitmap(imgBasePath + "user.png", wxBITMAP_TYPE_PNG) : *bitmap),
            wxPoint(-1, -1), wxSize(-1, -1));
    _chatBotTxt = std::make_unique<wxStaticText>(this, wxID_ANY, text, wxPoint(-1, -1),
    ...
    horzBoxSizer->Add(_chatBotTxt.get(), 8, wxEXPAND | wxALL, 1);
    horzBoxSizer->Add(_chatBotImg.get(), 2, wxEXPAND | wxALL, 1);
